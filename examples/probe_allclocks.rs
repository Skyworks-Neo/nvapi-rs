...
use nvapi::sys::api::{NvAPI_EnumPhysicalGPUs, NvAPI_GPU_GetAllClocks};
...
fn main() {
    ...
    let mut data = NV_GPU_CLOCK_INFO_V2 {
        version: nvapi::sys::api::NvVersion::new(std::mem::size_of::<NV_GPU_CLOCK_INFO_V2>(), 2),
        ..Default::default()
    };
